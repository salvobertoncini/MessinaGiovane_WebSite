...
$connessione_al_server=mysql_connect("localhost","sonynik9_mgadmin","q3Qc1p5RAnpP");  // ip locale, login e password
if(!$connessione_al_server){
die ('Non riesco a connettermi: errore '.mysql_error()); // questo apparirà solo se ci sarà un errore
}
 
$db_selected=mysql_select_db("sonynik9_messinagiovane",$connessione_al_server); // dove io ho scritto "prova" andrà inserito il nome del db
if(!$db_selected){
